...
### This was a group assignment for NSS Data Analytics Cohort DA5 in which all team members answered all prompts on their own and came together to put the best of their answers together.  In particular with this dashboard I contributed to the Map Graphic in the center of the dashboard as well as the vlookp driven "tax liability per person" dropdown an the vlookup driven pie chart showing specific states with the metric of +/- 50k on the return
